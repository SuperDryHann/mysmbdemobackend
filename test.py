...
async def call_model(
    ...
    response = llm_with_tools.ainvoke([system_prompt] + state["messages"], config)
...
async def run_workflow(graph):
    inputs = [HumanMessage(content="What is payment policy for UNSW?")]
    first = True
...
if __name__ == "__main__":
    ...
    asyncio.run(run_workflow(graph))